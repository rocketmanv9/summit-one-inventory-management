...
export function BaseMetricWidget({ widget, data, isLoading }: WidgetProps) {
  ...
  return (
    <div className="h-full flex flex-col justify-between p-6 bg-white rounded-lg border border-gray-200">
      <div className="text-sm font-medium text-gray-600">{widget.title}</div>
