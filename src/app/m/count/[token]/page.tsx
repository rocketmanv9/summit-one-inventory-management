  ...
  return (
    <div style={{ minHeight: '100dvh', background: colors.bg, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        {/* Scan button — plain link to dedicated scan page (no JS hydration needed) */}
        {!isSubmitted && (
          <a
            href={`/m/count/${token}/scan${bypass ? `?x-vercel-protection-bypass=${encodeURIComponent(bypass)}` : ''}`}
            style={{
              width: '100%', padding: '16px 20px', background: colors.blue600, color: colors.white,
              borderRadius: '14px', fontWeight: 700, fontSize: '16px', border: 'none',
              cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
              gap: '10px', boxShadow: '0 4px 14px rgba(37,99,235,0.3)',
