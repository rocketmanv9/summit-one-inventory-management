...
export async function POST(
  ...
  try {
    ...
    // Call RPC function: rpc_inv_fulfill_reservation_issue(p_tenant_id, p_reservation_id, p_fulfilled_by_user_id, p_last_event_id)
    const { data, error } = await supabase.rpc('rpc_inv_fulfill_reservation_issue', {
      p_tenant_id: tenantId,
      p_reservation_id: id,
      p_fulfilled_by_user_id: null, // TODO: Get from headers if needed
