...
}, { bodySchema: 'raw', serviceName: SERVICE_NAME, scope: 'PATCH /api/gv/vendors/[id]/addresses/[addressId]' });
...
}, { bodySchema: 'raw', serviceName: SERVICE_NAME, scope: 'DELETE /api/gv/vendors/[id]/addresses/[addressId]' });
