...
-- Drop with correct original signature
...
-- Try with any parameter signature
DROP FUNCTION IF EXISTS supply_chain.rpc_get_open_pos_for_receiving CASCADE;
...
GRANT EXECUTE ON FUNCTION supply_chain.rpc_get_open_pos_for_receiving TO authenticated, service_role;
