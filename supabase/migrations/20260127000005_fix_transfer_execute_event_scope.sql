-- Fix transfer execute event scope from 'inventory' to 'tenant'
...
BEGIN
    ...
    -- Publish event (FIXED: changed scope from 'inventory' to 'tenant')
...
COMMENT ON FUNCTION "inventory"."rpc_inv_transfer_execute" IS 'Executes transfer by writing paired ledger entries (idempotent) - Fixed event scope';
