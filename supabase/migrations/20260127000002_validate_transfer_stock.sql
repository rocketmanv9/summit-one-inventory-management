-- Add stock validation to transfer creation to prevent transfers from locations without sufficient stock
...
COMMENT ON FUNCTION "inventory"."rpc_inv_transfer_create" IS 'Creates transfer in draft status with stock validation - ensures items exist at source location with sufficient qty_on_hand';
